      ...
      try {
        ...
        if (eventsData && eventsData.length > 0) {
          const mappedEvents: HeritageEvent[] = eventsData.map(e => ({
            ...
            date: e.starts_at ? new Date(e.starts_at).toLocaleDateString() : 'Upcoming',
            time: e.starts_at ? new Date(e.starts_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : 'All day',
            location: e.location,
